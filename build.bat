...
if defined all (
    ...
    rem -D: Set preprocessor macro
    fxc shaders.hlsl !fxc_flags! -E vs -T vs_5_0 -Fo build\shaders\d3d11_vs.dxbc > nul -DSHADER_MODEL_5_0
    fxc shaders.hlsl !fxc_flags! -E ps -T ps_5_0 -Fo build\shaders\d3d11_ps.dxbc > nul -DSHADER_MODEL_5_0
    fxc shaders.hlsl !fxc_flags! -E vs -T vs_5_1 -Fo build\shaders\d3d12_vs.dxbc > nul -DBINDLESS
    fxc shaders.hlsl !fxc_flags! -E ps -T ps_5_1 -Fo build\shaders\d3d12_ps.dxbc > nul -DBINDLESS
    ...
    !dxc! shaders.hlsl !dxc_flags! -E vs -T vs_6_0 -Fo build\shaders\gl_vs.spv -vkbr b0 0 0 0 -vkbr b1 0 1 0 -vkbr t0 0 0 0 -vkbr t1 0 1 0 -vkbr t2 0 2 0 -vkbr t3 0 3 0 -vkbr s0 0 3 0
    !dxc! shaders.hlsl !dxc_flags! -E ps -T ps_6_0 -Fo build\shaders\gl_ps.spv -vkbr b0 0 0 0 -vkbr b1 0 1 0 -vkbr t0 0 0 0 -vkbr t1 0 1 0 -vkbr t2 0 2 0 -vkbr t3 0 3 0 -vkbr s0 0 3 0
    !dxc! shaders.hlsl !dxc_flags! -E vs -T vs_6_0 -Fo build\shaders\vk_vs.spv -DBINDLESS -vkbr b0 0 0 0 -vkbr b1 0 1 0 -vkbr t0 0 2 0 -vkbr t1 0 3 0 -vkbr t2 0 4 0 -vkbr t3 1 6 0 -vkbr s0 0 5 0
    !dxc! shaders.hlsl !dxc_flags! -E ps -T ps_6_0 -Fo build\shaders\vk_ps.spv -DBINDLESS -vkbr b0 0 0 0 -vkbr b1 0 1 0 -vkbr t0 0 2 0 -vkbr t1 0 3 0 -vkbr t2 0 4 0 -vkbr t3 1 6 0 -vkbr s0 0 5 0
