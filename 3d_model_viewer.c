...
typedef enum
{
    GRAPHICS_RESOURCE_PER_MESH_CONSTANTS,
...
// - Struct members aligned to 16 bytes
           ...
           pg_error* err)
{
    ...
    // Create update graphics messages.
    {
        ...
        // (3/mesh): Set per mesh constants/material
        //           Draw
        ...
        for (u32 i = 0; i < gp_count; i += 1)
        {
            ...
            // Set per mesh constants.
            {
                ...
                gfx_msgs[gfx_msg_count]
                    = init_gfx_msgs[GRAPHICS_RESOURCE_PER_MESH_CONSTANTS];
